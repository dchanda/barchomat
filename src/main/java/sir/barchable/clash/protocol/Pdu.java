...
public class Pdu {
    public enum Type {
        ...
        AllianceWarAttackVillageHiddenObjectData(24326),
        AllianceCreateFailed(24332),
        AllianceChangeFailed(24333),
        AvatarProfile(24334),
        AllianceWarData(24335),
        AllianceWarHistory(24338),
        BookmarksList(24340),
        ...
        AllianceWarVisitData(25000),
        AllianceWarAttackData(25003),
        AllianceWarAttackEvent(25006),
        Disconnected(25892),
